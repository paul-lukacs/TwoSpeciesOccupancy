...
load("/Users/pedromonterroso/Documents/Trabalho/Publications/Papers/In prep/1.spatiotemporal interactions among Iberian carnivores/1.data/occ.data/occ.RData")
cams <- y$ylp[,c(1:4)]

###########################
# PREPARE SITE COVARIATES #
###########################
sCovs <- read.csv("/Users/pedromonterroso/Documents/Trabalho/Publications/Papers/In prep/1.spatiotemporal interactions among Iberian carnivores/1.data/occ.data/siteCovs.csv",sep=",",header = T)
sCovs <- sCovs[,-1]
...
load("/Users/pedromonterroso/Documents/Trabalho/Publications/Papers/In prep/1.spatiotemporal interactions among Iberian carnivores/1.data/occ.data/det.Covs.RData")
